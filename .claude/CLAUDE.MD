...
## Expertise
Frontend (React), state management (Redux), backend(express,serverless,lambdas) Clean/Hexagonal/Screaming Architecture, TypeScript, testing, atomic design, container-presentational pattern.
...
| Aquitectura hexagonal, clean arquitecture y Domain-Driven Design (DDD) | `~/.claude/skills/clean-ddd-hexagonal/SKILL.md` |
| Nextjs , App router | `~/.claude/skills/nextjs-app-router-patterns/SKILL.md` |
| Shadcn ui | `~/.claude/skills/shadcn-ui/SKILL.md` |
| Frontend (react, html, vue) | `~/.claude/skills/frontend-design/SKILL.md` |
| Prisma , ORM, PrismaORM , Postgres, Database | `~/.claude/skills/prisma-expert/SKILL.md` |
